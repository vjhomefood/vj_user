...
/* ── South Indian food scatter — same style as user login ── */
const decorations = [
...
export default function DeliveryLoginScreen() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    setError('');
    try {
      await deliveryLogin(username.trim(), password.trim());
    ...
    >
      ...
      >
        ...
        >
          ...
          {/* VJ Logo — larger */}
          <div className="relative z-10 pt-7 pb-1 flex flex-col items-center gap-1">
            <img
            ...
            />
            <span className="text-[9px] font-black text-white/75 uppercase tracking-[0.22em] mt-0.5">
              Delivery Partner
            </span>
          </div>
        ...
        <div className="px-7 pb-8 pt-2">
          ...
          {/* Headline — same font style as user login */}
          <div className="text-center mb-5">
            <h1 className="text-[1.8rem] leading-none mb-2 select-none tracking-tight">
              {/* "Fresh & Fast" — Playfair Display bold serif */}
              <span
                style={{ fontFamily: '"Playfair Display", Georgia, serif', color: '#2C2520', fontWeight: 900 }}
              >
                Fresh &amp; Fast,{" "}
              </span>
              {/* "Every Day!" — Pacifico script, orange */}
              <span
            ...
            <p className="text-[13px] text-slate-500 leading-snug">
              Sign in to view your route sheet<br />and manage deliveries.
            </p>
          </div>
